...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid QuantisNet address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid QuantisNet address" in e.error['message'])
        ...
        # send 12 QUANTISNET to msig addr
