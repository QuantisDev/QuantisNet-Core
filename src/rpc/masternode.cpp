...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print QuantisNet address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "quantisnet",             "masternode",             &masternode,             true,  {} },
    { "quantisnet",             "masternodelist",         &masternodelist,         true,  {} },
    { "quantisnet",             "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "quantisnet",             "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "quantisnet",             "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "quantisnet",             "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
