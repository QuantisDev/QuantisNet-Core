...
2. run quantisnetd with -printalert or -sendalert like this:
   /path/to/quantisnetd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see http://www.quantisnet.world";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/QuantisNet Core:0.1.0.0/"));
