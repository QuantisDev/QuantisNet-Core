...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("strThirdPartyTxUrls"))
        settings.setValue("strThirdPartyTxUrls", QString("https://explore.quantisnet.network/tx/%s"));
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", QString("https://explore.quantisnet.network/tx/%s")).toString();
    ...
    if (!settings.contains("nPrivateSendAmount")) {
        ...
        if (!settings.contains("nAnonymizeQuantisNetAmount"))
            ...
            settings.setValue("nPrivateSendAmount", settings.value("nAnonymizeQuantisNetAmount").toInt());
    }
