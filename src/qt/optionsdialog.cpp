    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("QUANTISNET-light"), QVariant("light"));
    ui->theme->addItem(QString("QUANTISNET-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("QUANTISNET-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("QUANTISNET-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("QUANTISNET-traditional"), QVariant("trad"));
