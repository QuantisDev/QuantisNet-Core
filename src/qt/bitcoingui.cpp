...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to an QuantisNet address"));
    ...
    openAction->setStatusTip(tr("Open an quantisnet: URI or payment request"));
...
void BitcoinGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret)
{
    ...
    // Append title to "QuantisNet Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
