...
//
// OSX-specific way of handling quantisnet: URIs and PaymentRequest mime types.
...
bool PaymentServer::processPaymentRequest(const PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    Q_FOREACH(const PAIRTYPE(CScript, CAmount)& sendingTo, sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Unauthenticated payment requests to custom quantisnet addresses are not supported
        ...
        // QuantisNet amounts are stored as (optional) uint64 in the protobuf messages (see paymentrequest.proto),
