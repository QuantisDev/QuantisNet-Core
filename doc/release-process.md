...
* Update translations, see [translation_process.md](https://github.com/QuantisDev/QuantisNet-Core/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/QuantisDev/QuantisNet-Core/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Detached signatures will then be committed to the [dash-detached-sigs](https://github.com/QuantisDev/QuantisNet-Core-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/QuantisDev/QuantisNet-Core/releases/new) with a link to the archived release notes.
