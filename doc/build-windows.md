...
Some notes on how to build QuantisNet Core for Windows.
...
MinGW must be put into POSIX mode to allow for cross compilation of QuantisNet Core. Run the following command,
