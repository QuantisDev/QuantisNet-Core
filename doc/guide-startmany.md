...
### Send 10000 QUAN to New Addresses

Send exactly 10000 QUAN to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 10000 QUAN.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 10000 QUAN on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the dash github repo](https://github.com/QuantisDev/QuantisNet-Core/blob/master/doc/masternode_conf.md)
